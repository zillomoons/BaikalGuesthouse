...
},{"C:\\Users\\User\\Documents\\projectsDana\\baikalGuesthouse\\BaikalGuesthouse\\images\\baikal\\banner.jpg":[["banner.a5e2acff.jpg","images/baikal/banner.jpg"],"images/baikal/banner.jpg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"images/rooms/room2.jpg":[function(require,module,exports) {
module.exports = "/room2.3d535433.jpg";
},{}],"images/rooms/room3.jpg":[function(require,module,exports) {
module.exports = "/room3.3e9c77c0.jpg";
},{}],"images/rooms/room4.jpg":[function(require,module,exports) {
module.exports = "/room4.6fdc87a0.jpg";
},{}],"images/rooms/room5.jpg":[function(require,module,exports) {
module.exports = "/room5.f33e145a.jpg";
...
var menuOverlay = document.querySelector('.menu_container');
var body = document.querySelector('body');
var header = document.querySelector('header'); // Open mobile menu
...
window.addEventListener('scroll', menuPosition); // check Menu position
...
var prev_btn = document.querySelector('#btn_prev');
...
next_btn.addEventListener('click', function () {
  var active_slide = document.querySelector('.slider__slide.active');
  var nextSibling = active_slide.nextElementSibling;
...
prev_btn.addEventListener('click', function () {
  var active_slide = document.querySelector('.slider__slide.active');
  var nextSibling = active_slide.previousElementSibling;
...
var roomDescrip = document.querySelectorAll('.slider__descrip');
var roomTitles = document.querySelectorAll('slider__title');

var showRoomDescr = function showRoomDescr() {
  roomDescrip.forEach(function (descrip) {
    descrip.classList.toggle('visible');
  });
};

document.querySelectorAll('.slider__title').forEach(function (title) {
...
var scrollAppear = function scrollAppear() {
  for (var i = 0; i < hiddenElems.length; i++) {
    var posFromTop = hiddenElems[i].getBoundingClientRect().top;
...
},{"./scss/styles.scss":"scss/styles.scss","/images/rooms/room2.jpg":"images/rooms/room2.jpg","/images/rooms/room3.jpg":"images/rooms/room3.jpg","/images/rooms/room4.jpg":"images/rooms/room4.jpg","/images/rooms/room5.jpg":"images/rooms/room5.jpg"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/BaikalGuesthouse.e31bb0bc.js.map